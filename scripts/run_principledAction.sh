...
###############################################################################
# Principled Action Generation Pipeline
# 
...
#
# Usage:
#   bash scripts/run_principledAction.sh <mode> [checkpoint_dir]
#
# Modes:
...
#
# Example:
#   bash scripts/run_principledAction.sh gen logs/primal/motion_diffuser_ar_30fps/runs/2025-02-01_05-14-50_silu_anchor
###############################################################################
...
readonly OUTPUT_DIR="outputs/PrincipledActionGen"
...
echo "========================================="
echo "Principled Action Generation Pipeline"
echo "Mode: $MODE"
...
generate_motions() {
    ...
    for expdir in "${EXPERIMENTS[@]}"; do
        ...
        for action in "${ACTIONS[@]}"; do
            ...
            $PYTHON_CMD experiments/gen_PrincipledActGen.py \
                --expdir "$expdir" \
                --action "$action" \
                $GENERATION_PARAMS
